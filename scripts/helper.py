...
from subaligner.exception import NoFrameRateException
...
class MediaHelper(object):
    ...
    __CMD_TIME_OUT = 10000  # time out for subprocess
    ...
    def extract_audio(self, video_file_path, TEMP_DIR_PATH, channel, decompress: bool = False, freq: int = 16000) -> str:
